...
function TaraApp(){
  ...
  const analysis=useMemo(()=>{
    try{
      ...
      const CONSECUTIVE_NEEDED=(_isExtreme||_isFgtFullAlign)?1:Math.max(1,Math.round(_baseConsec*_velSampleAdj)+_trajShortcut+_fgtShortcut+_push+_consensusOverride+_convictionShortcut);
