...
// V133: Baseline version marker — bump when SEED_TRADES is refreshed.
// Personal layer compares this on load and offers a sync prompt if the user's
// last-synced version is older than the current baked baseline.
const BASELINE_VERSION='2026.04.29-v133-377t-423W266L-equal-consideration';
const BASELINE_RECORD={'15m':{wins:423,losses:266},'5m':{wins:31,losses:25}};

const SEED_TRADES=[
  // V133 BAKED TRAINING: 377 trades. Running baseline: 423W-266L (61.4%)
  // Per-direction: UP 218, DOWN 159
  ...
  {id:1777059203093,dir:'UP',posterior:63.5,regime:'RANGE-CHOP',clockAtLock:697,hour:15,session:'US',windowType:'15m',signals:{gap:0.0,momentum:0.0,structure:0.0,flow:0.0,technical:0.0,regime:0.0},result:'WIN'},
  {id:1777060184567,dir:'DOWN',posterior:14.3,regime:'RANGE-CHOP',clockAtLock:615,hour:15,session:'US',windowType:'15m',signals:{gap:0.0,momentum:0.0,structure:0.0,flow:0.0,technical:0.0,regime:0.0},result:'WIN'},
  {id:1777060911312,dir:'DOWN',posterior:16.2,regime:'RANGE-CHOP',clockAtLock:788,hour:16,session:'US',windowType:'15m',signals:{gap:0.0,momentum:0.0,structure:0.0,flow:0.0,technical:0.0,regime:0.0},result:'WIN'},
  {id:1777061989693,dir:'UP',posterior:86.7,regime:'SHORT SQUEEZE',clockAtLock:610,hour:16,session:'US',windowType:'15m',signals:{gap:0.0,momentum:0.0,structure:0.0,flow:0.0,technical:0.0,regime:0.0},result:'LOSS'},
  {id:1777062667638,dir:'UP',posterior:82.1,regime:'SHORT SQUEEZE',clockAtLock:832,hour:16,session:'US',windowType:'15m',signals:{gap:0.0,momentum:0.0,structure:0.0,flow:0.0,technical:0.0,regime:0.0},result:'WIN'},
  {id:1777063544945,dir:'UP',posterior:82.1,regime:'SHORT SQUEEZE',clockAtLock:855,hour:16,session:'US',windowType:'15m',signals:{gap:0.0,momentum:0.0,structure:0.0,flow:0.0,technical:0.0,regime:0.0},result:'WIN'},
  {id:1777064617357,dir:'UP',posterior:85.8,regime:'SHORT SQUEEZE',clockAtLock:682,hour:17,session:'US',windowType:'15m',signals:{gap:0.0,momentum:0.0,structure:0.0,flow:0.0,technical:0.0,regime:0.0},result:'LOSS'},
  {id:1777065492127,dir:'DOWN',posterior:16.5,regime:'RANGE-CHOP',clockAtLock:707,hour:17,session:'US',windowType:'15m',signals:{gap:0.0,momentum:0.0,structure:0.0,flow:0.0,technical:0.0,regime:0.0},result:'WIN'},
  {id:1777066453043,dir:'UP',posterior:87.4,regime:'SHORT SQUEEZE',clockAtLock:647,hour:17,session:'US',windowType:'15m',signals:{gap:0.0,momentum:0.0,structure:0.0,flow:0.0,technical:0.0,regime:0.0},result:'LOSS'},
  {id:1777069225152,dir:'UP',posterior:89.2,regime:'SHORT SQUEEZE',clockAtLock:575,hour:18,session:'OFF-HOURS',windowType:'15m',signals:{gap:0.0,momentum:0.0,structure:0.0,flow:0.0,technical:0.0,regime:0.0},result:'LOSS'},
  {id:1777072008936,dir:'UP',posterior:89.2,regime:'SHORT SQUEEZE',clockAtLock:491,hour:19,session:'OFF-HOURS',windowType:'15m',signals:{gap:0.0,momentum:0.0,structure:0.0,flow:0.0,technical:0.0,regime:0.0},result:'WIN'},
  {id:1777072871358,dir:'DOWN',posterior:15.1,regime:'TRENDING DOWN',clockAtLock:529,hour:19,session:'OFF-HOURS',windowType:'15m',signals:{gap:0.0,momentum:0.0,structure:0.0,flow:0.0,technical:0.0,regime:0.0},result:'LOSS'},
  {id:1777073760138,dir:'UP',posterior:85.7,regime:'RANGE-CHOP',clockAtLock:540,hour:19,session:'OFF-HOURS',windowType:'15m',signals:{gap:0.0,momentum:0.0,structure:0.0,flow:0.0,technical:0.0,regime:0.0},result:'WIN'},
  {id:1777074644894,dir:'UP',posterior:89.2,regime:'SHORT SQUEEZE',clockAtLock:555,hour:19,session:'OFF-HOURS',windowType:'15m',signals:{gap:0.0,momentum:0.0,structure:0.0,flow:0.0,technical:0.0,regime:0.0},result:'LOSS'},
  {id:1777075501256,dir:'DOWN',posterior:15.0,regime:'TRENDING DOWN',clockAtLock:599,hour:20,session:'ASIA',windowType:'15m',signals:{gap:0.0,momentum:0.0,structure:0.0,flow:0.0,technical:0.0,regime:0.0},result:'WIN'},
  {id:1777274299546,dir:'UP',posterior:81.1,regime:'SHORT SQUEEZE',clockAtLock:701,hour:3,session:'EU',windowType:'15m',signals:{gap:0.0,momentum:0.0,structure:0.0,flow:0.0,technical:0.0,regime:0.0},result:'WIN'},
  {id:1777275074427,dir:'UP',posterior:82.1,regime:'RANGE-CHOP',clockAtLock:825,hour:3,session:'EU',windowType:'15m',signals:{gap:0.0,momentum:0.0,structure:0.0,flow:0.0,technical:0.0,regime:0.0},result:'LOSS'},
  {id:1777276165127,dir:'DOWN',posterior:13.8,regime:'RANGE-CHOP',clockAtLock:635,hour:3,session:'EU',windowType:'15m',signals:{gap:0.0,momentum:0.0,structure:0.0,flow:0.0,technical:0.0,regime:0.0},result:'WIN'},
  {id:1777276901600,dir:'UP',posterior:81.4,regime:'SHORT SQUEEZE',clockAtLock:798,hour:4,session:'EU',windowType:'15m',signals:{gap:0.0,momentum:0.0,structure:0.0,flow:0.0,technical:0.0,regime:0.0},result:'WIN'},
  {id:1777277798420,dir:'UP',posterior:80.4,regime:'RANGE-CHOP',clockAtLock:801,hour:4,session:'EU',windowType:'15m',signals:{gap:0.0,momentum:0.0,structure:0.0,flow:0.0,technical:0.0,regime:0.0},result:'LOSS'},
  {id:1777278720871,dir:'DOWN',posterior:17.8,regime:'RANGE-CHOP',clockAtLock:779,hour:4,session:'EU',windowType:'15m',signals:{gap:0.0,momentum:0.0,structure:0.0,flow:0.0,technical:0.0,regime:0.0},result:'LOSS'},
  {id:1777308913391,dir:'UP',posterior:89.2,regime:'SHORT SQUEEZE',clockAtLock:287,hour:12,session:'US',windowType:'15m',signals:{gap:0.0,momentum:0.0,structure:0.0,flow:0.0,technical:0.0,regime:0.0},result:'LOSS'},
  {id:1777309443276,dir:'UP',posterior:89.2,regime:'SHORT SQUEEZE',clockAtLock:657,hour:13,session:'US',windowType:'15m',signals:{gap:0.0,momentum:0.0,structure:0.0,flow:0.0,technical:0.0,regime:0.0},result:'WIN'},
  {id:1777311211227,dir:'UP',posterior:89.2,regime:'SHORT SQUEEZE',clockAtLock:688,hour:13,session:'US',windowType:'15m',signals:{gap:0.0,momentum:0.0,structure:0.0,flow:0.0,technical:0.0,regime:0.0},result:'WIN'},
  {id:1777312107242,dir:'DOWN',posterior:12.9,regime:'HIGH VOL CHOP',clockAtLock:692,hour:13,session:'US',windowType:'15m',signals:{gap:0.0,momentum:0.0,structure:0.0,flow:0.0,technical:0.0,regime:0.0},result:'WIN'},
  {id:1777312909865,dir:'UP',posterior:85.7,regime:'SHORT SQUEEZE',clockAtLock:790,hour:14,session:'US',windowType:'15m',signals:{gap:0.0,momentum:0.0,structure:0.0,flow:0.0,technical:0.0,regime:0.0},result:'WIN'},
  {id:1777313854145,dir:'UP',posterior:85.7,regime:'SHORT SQUEEZE',clockAtLock:746,hour:14,session:'US',windowType:'15m',signals:{gap:0.0,momentum:0.0,structure:0.0,flow:0.0,technical:0.0,regime:0.0},result:'LOSS'},
  {id:1777314799534,dir:'UP',posterior:89.7,regime:'RANGE-CHOP',clockAtLock:700,hour:14,session:'US',windowType:'15m',signals:{gap:0.0,momentum:0.0,structure:0.0,flow:0.0,technical:0.0,regime:0.0},result:'WIN'},
  {id:1777315618956,dir:'UP',posterior:85.7,regime:'SHORT SQUEEZE',clockAtLock:781,hour:14,session:'US',windowType:'15m',signals:{gap:0.0,momentum:0.0,structure:0.0,flow:0.0,technical:0.0,regime:0.0},result:'WIN'},
  {id:1777316882788,dir:'UP',posterior:87.7,regime:'RANGE-CHOP',clockAtLock:417,hour:15,session:'US',windowType:'15m',signals:{gap:0.0,momentum:0.0,structure:0.0,flow:0.0,technical:0.0,regime:0.0},result:'WIN'},
  {id:1777317594530,dir:'DOWN',posterior:13.2,regime:'TRENDING DOWN',clockAtLock:605,hour:15,session:'US',windowType:'15m',signals:{gap:0.0,momentum:0.0,structure:0.0,flow:0.0,technical:0.0,regime:0.0},result:'WIN'},
  {id:1777318350768,dir:'UP',posterior:85.0,regime:'SHORT SQUEEZE',clockAtLock:749,hour:15,session:'US',windowType:'15m',signals:{gap:0.0,momentum:0.0,structure:0.0,flow:0.0,technical:0.0,regime:0.0},result:'WIN'},
  {id:1777319122198,dir:'UP',posterior:82.1,regime:'SHORT SQUEEZE',clockAtLock:878,hour:15,session:'US',windowType:'15m',signals:{gap:0.0,momentum:0.0,structure:0.0,flow:0.0,technical:0.0,regime:0.0},result:'WIN'},
  {id:1777320123442,dir:'UP',posterior:87.3,regime:'RANGE-CHOP',clockAtLock:777,hour:16,session:'US',windowType:'15m',signals:{gap:0.0,momentum:0.0,structure:0.0,flow:0.0,technical:0.0,regime:0.0},result:'WIN'},
  {id:1777320917808,dir:'UP',posterior:82.1,regime:'SHORT SQUEEZE',clockAtLock:883,hour:16,session:'US',windowType:'15m',signals:{gap:0.0,momentum:0.0,structure:0.0,flow:0.0,technical:0.0,regime:0.0},result:'WIN'},
  {id:1777322007975,dir:'DOWN',posterior:13.3,regime:'RANGE-CHOP',clockAtLock:693,hour:16,session:'US',windowType:'15m',signals:{gap:0.0,momentum:0.0,structure:0.0,flow:0.0,technical:0.0,regime:0.0},result:'WIN'},
  {id:1777323034839,dir:'DOWN',posterior:15.0,regime:'RANGE-CHOP',clockAtLock:566,hour:16,session:'US',windowType:'15m',signals:{gap:0.0,momentum:0.0,structure:0.0,flow:0.0,technical:0.0,regime:0.0},result:'LOSS'},
  {id:1777323939155,dir:'DOWN',posterior:13.1,regime:'RANGE-CHOP',clockAtLock:561,hour:17,session:'US',windowType:'15m',signals:{gap:0.0,momentum:0.0,structure:0.0,flow:0.0,technical:0.0,regime:0.0},result:'WIN'},
  {id:1777324639456,dir:'UP',posterior:85.7,regime:'SHORT SQUEEZE',clockAtLock:761,hour:17,session:'US',windowType:'15m',signals:{gap:0.0,momentum:0.0,structure:0.0,flow:0.0,technical:0.0,regime:0.0},result:'WIN'},
  {id:1777326056921,dir:'DOWN',posterior:13.6,regime:'RANGE-CHOP',clockAtLock:243,hour:17,session:'US',windowType:'15m',signals:{gap:0.0,momentum:0.0,structure:0.0,flow:0.0,technical:0.0,regime:0.0},result:'WIN'},
  {id:1777326503155,dir:'DOWN',posterior:13.8,regime:'RANGE-CHOP',clockAtLock:697,hour:17,session:'US',windowType:'15m',signals:{gap:0.0,momentum:0.0,structure:0.0,flow:0.0,technical:0.0,regime:0.0},result:'WIN'},
  {id:1777327525912,dir:'DOWN',posterior:13.9,regime:'TRENDING DOWN',clockAtLock:574,hour:18,session:'OFF-HOURS',windowType:'15m',signals:{gap:0.0,momentum:0.0,structure:0.0,flow:0.0,technical:0.0,regime:0.0},result:'LOSS'},
  {id:1777328394664,dir:'DOWN',posterior:12.7,regime:'RANGE-CHOP',clockAtLock:605,hour:18,session:'OFF-HOURS',windowType:'15m',signals:{gap:0.0,momentum:0.0,structure:0.0,flow:0.0,technical:0.0,regime:0.0},result:'LOSS'},
  {id:1777329081140,dir:'UP',posterior:82.1,regime:'RANGE-CHOP',clockAtLock:819,hour:18,session:'OFF-HOURS',windowType:'15m',signals:{gap:0.0,momentum:0.0,structure:0.0,flow:0.0,technical:0.0,regime:0.0},result:'WIN'},
  {id:1777329937896,dir:'UP',posterior:82.1,regime:'SHORT SQUEEZE',clockAtLock:862,hour:18,session:'OFF-HOURS',windowType:'15m',signals:{gap:0.0,momentum:0.0,structure:0.0,flow:0.0,technical:0.0,regime:0.0},result:'WIN'},
  {id:1777330865421,dir:'UP',posterior:82.1,regime:'SHORT SQUEEZE',clockAtLock:834,hour:19,session:'OFF-HOURS',windowType:'15m',signals:{gap:0.0,momentum:0.0,structure:0.0,flow:0.0,technical:0.0,regime:0.0},result:'LOSS'},
  {id:1777331767363,dir:'UP',posterior:82.1,regime:'SHORT SQUEEZE',clockAtLock:832,hour:19,session:'OFF-HOURS',windowType:'15m',signals:{gap:0.0,momentum:0.0,structure:0.0,flow:0.0,technical:0.0,regime:0.0},result:'WIN'},
  {id:1777332726577,dir:'UP',posterior:85.7,regime:'RANGE-CHOP',clockAtLock:773,hour:19,session:'OFF-HOURS',windowType:'15m',signals:{gap:0.0,momentum:0.0,structure:0.0,flow:0.0,technical:0.0,regime:0.0},result:'WIN'},
  {id:1777333558063,dir:'UP',posterior:82.1,regime:'SHORT SQUEEZE',clockAtLock:842,hour:19,session:'OFF-HOURS',windowType:'15m',signals:{gap:0.0,momentum:0.0,structure:0.0,flow:0.0,technical:0.0,regime:0.0},result:'WIN'},
  {id:1777334452003,dir:'DOWN',posterior:20.1,regime:'TRENDING DOWN',clockAtLock:848,hour:20,session:'ASIA',windowType:'15m',signals:{gap:0.0,momentum:0.0,structure:0.0,flow:0.0,technical:0.0,regime:0.0},result:'WIN'},
  {id:1777335317212,dir:'UP',posterior:82.1,regime:'SHORT SQUEEZE',clockAtLock:882,hour:20,session:'ASIA',windowType:'15m',signals:{gap:0.0,momentum:0.0,structure:0.0,flow:0.0,technical:0.0,regime:0.0},result:'LOSS'},
  {id:1777337320337,dir:'DOWN',posterior:27.7,regime:'TRENDING DOWN',clockAtLock:679,hour:20,session:'ASIA',windowType:'15m',signals:{gap:0.0,momentum:0.0,structure:0.0,flow:0.0,technical:0.0,regime:0.0},result:'WIN'},
  {id:1777338053199,dir:'UP',posterior:82.1,regime:'SHORT SQUEEZE',clockAtLock:846,hour:21,session:'ASIA',windowType:'15m',signals:{gap:0.0,momentum:0.0,structure:0.0,flow:0.0,technical:0.0,regime:0.0},result:'LOSS'},
  {id:1777341291514,dir:'UP',posterior:88.5,regime:'RANGE-CHOP',clockAtLock:309,hour:21,session:'ASIA',windowType:'15m',signals:{gap:0.0,momentum:0.0,structure:0.0,flow:0.0,technical:0.0,regime:0.0},result:'LOSS'},
  {id:1777342672046,dir:'UP',posterior:86.2,regime:'RANGE-CHOP',clockAtLock:727,hour:22,session:'ASIA',windowType:'15m',signals:{gap:0.0,momentum:0.0,structure:0.0,flow:0.0,technical:0.0,regime:0.0},result:'LOSS'},
  {id:1777343548896,dir:'UP',posterior:42.4,regime:'RANGE-CHOP',clockAtLock:751,hour:22,session:'ASIA',windowType:'15m',signals:{gap:0.0,momentum:0.0,structure:0.0,flow:0.0,technical:0.0,regime:0.0},result:'LOSS'},
  {id:1777344419169,dir:'UP',posterior:85.7,regime:'SHORT SQUEEZE',clockAtLock:781,hour:22,session:'ASIA',windowType:'15m',signals:{gap:0.0,momentum:0.0,structure:0.0,flow:0.0,technical:0.0,regime:0.0},result:'WIN'},
  {id:1777345706542,dir:'DOWN',posterior:41.6,regime:'RANGE-CHOP',clockAtLock:394,hour:23,session:'ASIA',windowType:'15m',signals:{gap:0.0,momentum:0.0,structure:0.0,flow:0.0,technical:0.0,regime:0.0},result:'WIN'},
  {id:1777346161561,dir:'UP',posterior:82.1,regime:'SHORT SQUEEZE',clockAtLock:838,hour:23,session:'ASIA',windowType:'15m',signals:{gap:0.0,momentum:0.0,structure:0.0,flow:0.0,technical:0.0,regime:0.0},result:'WIN'},
  {id:1777347116516,dir:'UP',posterior:84.9,regime:'RANGE-CHOP',clockAtLock:783,hour:23,session:'ASIA',windowType:'15m',signals:{gap:0.0,momentum:0.0,structure:0.0,flow:0.0,technical:0.0,regime:0.0},result:'WIN'},
  {id:1777348241983,dir:'UP',posterior:89.2,regime:'RANGE-CHOP',clockAtLock:558,hour:23,session:'ASIA',windowType:'15m',signals:{gap:0.0,momentum:0.0,structure:0.0,flow:0.0,technical:0.0,regime:0.0},result:'WIN'},
  {id:1777349390505,dir:'UP',posterior:87.6,regime:'SHORT SQUEEZE',clockAtLock:310,hour:0,session:'ASIA',windowType:'15m',signals:{gap:0.0,momentum:0.0,structure:0.0,flow:0.0,technical:0.0,regime:0.0},result:'WIN'},
  {id:1777349776414,dir:'UP',posterior:82.1,regime:'SHORT SQUEEZE',clockAtLock:824,hour:0,session:'ASIA',windowType:'15m',signals:{gap:0.0,momentum:0.0,structure:0.0,flow:0.0,technical:0.0,regime:0.0},result:'LOSS'},
  {id:1777351418608,dir:'DOWN',posterior:89.2,regime:'RANGE-CHOP',clockAtLock:82,hour:0,session:'ASIA',windowType:'15m',signals:{gap:0.0,momentum:0.0,structure:0.0,flow:0.0,technical:0.0,regime:0.0},result:'LOSS'},
  {id:1777351517781,dir:'UP',posterior:82.1,regime:'SHORT SQUEEZE',clockAtLock:883,hour:0,session:'ASIA',windowType:'15m',signals:{gap:0.0,momentum:0.0,structure:0.0,flow:0.0,technical:0.0,regime:0.0},result:'WIN'},
  {id:1777352429369,dir:'UP',posterior:82.1,regime:'SHORT SQUEEZE',clockAtLock:871,hour:1,session:'ASIA',windowType:'15m',signals:{gap:0.0,momentum:0.0,structure:0.0,flow:0.0,technical:0.0,regime:0.0},result:'WIN'},
  {id:1777353943606,dir:'UP',posterior:89.2,regime:'RANGE-CHOP',clockAtLock:257,hour:1,session:'ASIA',windowType:'15m',signals:{gap:0.0,momentum:0.0,structure:0.0,flow:0.0,technical:0.0,regime:0.0},result:'WIN'},
  {id:1777355570309,dir:'UP',posterior:82.1,regime:'RANGE-CHOP',clockAtLock:430,hour:1,session:'ASIA',windowType:'15m',signals:{gap:0.0,momentum:0.0,structure:0.0,flow:0.0,technical:0.0,regime:0.0},result:'WIN'},
  {id:1777357822576,dir:'UP',posterior:82.1,regime:'SHORT SQUEEZE',clockAtLock:878,hour:2,session:'ASIA',windowType:'15m',signals:{gap:0.0,momentum:0.0,structure:0.0,flow:0.0,technical:0.0,regime:0.0},result:'LOSS'},
  {id:1777359698621,dir:'UP',posterior:82.1,regime:'SHORT SQUEEZE',clockAtLock:801,hour:3,session:'EU',windowType:'15m',signals:{gap:0.0,momentum:0.0,structure:0.0,flow:0.0,technical:0.0,regime:0.0},result:'LOSS'},
  {id:1777364154586,dir:'UP',posterior:82.1,regime:'SHORT SQUEEZE',clockAtLock:846,hour:4,session:'EU',windowType:'15m',signals:{gap:0.0,momentum:0.0,structure:0.0,flow:0.0,technical:0.0,regime:0.0},result:'WIN'},
  {id:1777365385527,dir:'DOWN',posterior:88.7,regime:'SHORT SQUEEZE',clockAtLock:515,hour:4,session:'EU',windowType:'15m',signals:{gap:0.0,momentum:0.0,structure:0.0,flow:0.0,technical:0.0,regime:0.0},result:'WIN'},
  {id:1777366820553,dir:'UP',posterior:81.2,regime:'RANGE-CHOP',clockAtLock:880,hour:5,session:'EU',windowType:'15m',signals:{gap:0.0,momentum:0.0,structure:0.0,flow:0.0,technical:0.0,regime:0.0},result:'LOSS'},
  {id:1777395114634,dir:'UP',posterior:89.2,regime:'RANGE-CHOP',clockAtLock:486,hour:12,session:'US',windowType:'15m',signals:{gap:0.0,momentum:0.0,structure:0.0,flow:0.0,technical:0.0,regime:0.0},result:'WIN'},
  {id:1777395760158,dir:'DOWN',posterior:52.6,regime:'TRENDING DOWN',clockAtLock:740,hour:13,session:'US',windowType:'15m',signals:{gap:0.0,momentum:0.0,structure:0.0,flow:0.0,technical:0.0,regime:0.0},result:'WIN'},
  {id:1777400196355,dir:'UP',posterior:82.1,regime:'SHORT SQUEEZE',clockAtLock:804,hour:14,session:'US',windowType:'15m',signals:{gap:0.0,momentum:0.0,structure:0.0,flow:0.0,technical:0.0,regime:0.0},result:'WIN'},
  {id:1777402987950,dir:'DOWN',posterior:84.7,regime:'RANGE-CHOP',clockAtLock:712,hour:15,session:'US',windowType:'15m',signals:{gap:0.0,momentum:0.0,structure:0.0,flow:0.0,technical:0.0,regime:0.0},result:'WIN'},
  {id:1777403830368,dir:'UP',posterior:83.6,regime:'RANGE-CHOP',clockAtLock:770,hour:15,session:'US',windowType:'15m',signals:{gap:0.0,momentum:0.0,structure:0.0,flow:0.0,technical:0.0,regime:0.0},result:'WIN'},
  {id:1777406069254,dir:'UP',posterior:88.5,regime:'RANGE-CHOP',clockAtLock:331,hour:15,session:'US',windowType:'15m',signals:{gap:0.0,momentum:0.0,structure:0.0,flow:0.0,technical:0.0,regime:0.0},result:'WIN'},
  {id:1777406744159,dir:'UP',posterior:90.8,regime:'RANGE-CHOP',clockAtLock:556,hour:16,session:'US',windowType:'15m',signals:{gap:0.0,momentum:0.0,structure:0.0,flow:0.0,technical:0.0,regime:0.0},result:'WIN'},
  {id:1777409390680,dir:'UP',posterior:89.7,regime:'RANGE-CHOP',clockAtLock:609,hour:16,session:'US',windowType:'15m',signals:{gap:0.0,momentum:0.0,structure:0.0,flow:0.0,technical:0.0,regime:0.0},result:'WIN'},
  {id:1777410086190,dir:'UP',posterior:82.4,regime:'RANGE-CHOP',clockAtLock:813,hour:17,session:'US',windowType:'15m',signals:{gap:0.0,momentum:0.0,structure:0.0,flow:0.0,technical:0.0,regime:0.0},result:'LOSS'},
  {id:1777411012427,dir:'DOWN',posterior:82.6,regime:'RANGE-CHOP',clockAtLock:787,hour:17,session:'US',windowType:'15m',signals:{gap:0.0,momentum:0.0,structure:0.0,flow:0.0,technical:0.0,regime:0.0},result:'WIN'},
  {id:1777412237052,dir:'UP',posterior:89.7,regime:'SHORT SQUEEZE',clockAtLock:463,hour:17,session:'US',windowType:'15m',signals:{gap:0.0,momentum:0.0,structure:0.0,flow:0.0,technical:0.0,regime:0.0},result:'WIN'},
  {id:1777412855822,dir:'UP',posterior:86.1,regime:'SHORT SQUEEZE',clockAtLock:744,hour:17,session:'US',windowType:'15m',signals:{gap:0.0,momentum:0.0,structure:0.0,flow:0.0,technical:0.0,regime:0.0},result:'WIN'},
  {id:1777413696037,dir:'UP',posterior:82.6,regime:'SHORT SQUEEZE',clockAtLock:804,hour:18,session:'OFF-HOURS',windowType:'15m',signals:{gap:0.0,momentum:0.0,structure:0.0,flow:0.0,technical:0.0,regime:0.0},result:'LOSS'},
  {id:1777418286908,dir:'DOWN',posterior:53.2,regime:'RANGE-CHOP',clockAtLock:713,hour:19,session:'OFF-HOURS',windowType:'15m',signals:{gap:0.0,momentum:0.0,structure:0.0,flow:0.0,technical:0.0,regime:0.0},result:'WIN'},
  {id:1777419496111,dir:'UP',posterior:85.6,regime:'RANGE-CHOP',clockAtLock:403,hour:19,session:'OFF-HOURS',windowType:'15m',signals:{gap:0.0,momentum:0.0,structure:0.0,flow:0.0,technical:0.0,regime:0.0},result:'WIN'},
  {id:1777420179204,dir:'UP',posterior:38.0,regime:'RANGE-CHOP',clockAtLock:620,hour:19,session:'OFF-HOURS',windowType:'15m',signals:{gap:0.0,momentum:0.0,structure:0.0,flow:0.0,technical:0.0,regime:0.0},result:'WIN'},
  {id:1777421255422,dir:'DOWN',posterior:80.3,regime:'RANGE-CHOP',clockAtLock:444,hour:20,session:'ASIA',windowType:'15m',signals:{gap:0.0,momentum:0.0,structure:0.0,flow:0.0,technical:0.0,regime:0.0},result:'WIN'},
  {id:1777421946058,dir:'DOWN',posterior:39.2,regime:'RANGE-CHOP',clockAtLock:654,hour:20,session:'ASIA',windowType:'15m',signals:{gap:0.0,momentum:0.0,structure:0.0,flow:0.0,technical:0.0,regime:0.0},result:'WIN'},
  {id:1777433928516,dir:'UP',posterior:87.4,regime:'RANGE-CHOP',clockAtLock:371,hour:23,session:'ASIA',windowType:'15m',signals:{gap:0.0,momentum:0.0,structure:0.0,flow:0.0,technical:0.0,regime:0.0},result:'WIN'},
  {id:1777434359223,dir:'DOWN',posterior:53.1,regime:'RANGE-CHOP',clockAtLock:841,hour:23,session:'ASIA',windowType:'15m',signals:{gap:0.0,momentum:0.0,structure:0.0,flow:0.0,technical:0.0,regime:0.0},result:'WIN'},
  {id:1777435238365,dir:'DOWN',posterior:82.6,regime:'RANGE-CHOP',clockAtLock:862,hour:0,session:'ASIA',windowType:'15m',signals:{gap:0.0,momentum:0.0,structure:0.0,flow:0.0,technical:0.0,regime:0.0},result:'WIN'},
  {id:1777436218590,dir:'UP',posterior:82.6,regime:'SHORT SQUEEZE',clockAtLock:781,hour:0,session:'ASIA',windowType:'15m',signals:{gap:0.0,momentum:0.0,structure:0.0,flow:0.0,technical:0.0,regime:0.0},result:'WIN'},
  {id:1777437026500,dir:'DOWN',posterior:82.6,regime:'SHORT SQUEEZE',clockAtLock:873,hour:0,session:'ASIA',windowType:'15m',signals:{gap:0.0,momentum:0.0,structure:0.0,flow:0.0,technical:0.0,regime:0.0},result:'LOSS'},
  {id:1777437935795,dir:'DOWN',posterior:39.8,regime:'RANGE-CHOP',clockAtLock:864,hour:0,session:'ASIA',windowType:'15m',signals:{gap:0.0,momentum:0.0,structure:0.0,flow:0.0,technical:0.0,regime:0.0},result:'WIN'},
  {id:1777439139807,dir:'DOWN',posterior:37.0,regime:'RANGE-CHOP',clockAtLock:560,hour:1,session:'ASIA',windowType:'15m',signals:{gap:0.0,momentum:0.0,structure:0.0,flow:0.0,technical:0.0,regime:0.0},result:'WIN'},
  {id:1777439731788,dir:'DOWN',posterior:52.7,regime:'RANGE-CHOP',clockAtLock:868,hour:1,session:'ASIA',windowType:'15m',signals:{gap:0.0,momentum:0.0,structure:0.0,flow:0.0,technical:0.0,regime:0.0},result:'LOSS'},
  {id:1777440865519,dir:'DOWN',posterior:81.1,regime:'TRENDING DOWN',clockAtLock:634,hour:1,session:'ASIA',windowType:'15m',signals:{gap:0.0,momentum:0.0,structure:0.0,flow:0.0,technical:0.0,regime:0.0},result:'WIN'},
  {id:1777441625399,dir:'DOWN',posterior:82.5,regime:'RANGE-CHOP',clockAtLock:775,hour:1,session:'ASIA',windowType:'15m',signals:{gap:0.0,momentum:0.0,structure:0.0,flow:0.0,technical:0.0,regime:0.0},result:'LOSS'},
  {id:1777443348117,dir:'UP',posterior:59.4,regime:'RANGE-CHOP',clockAtLock:852,hour:2,session:'ASIA',windowType:'15m',signals:{gap:0.0,momentum:0.0,structure:0.0,flow:0.0,technical:0.0,regime:0.0},result:'LOSS'},
  {id:1777444230629,dir:'UP',posterior:81.7,regime:'RANGE-CHOP',clockAtLock:870,hour:2,session:'ASIA',windowType:'15m',signals:{gap:0.0,momentum:0.0,structure:0.0,flow:0.0,technical:0.0,regime:0.0},result:'LOSS'},
  {id:1777446036113,dir:'UP',posterior:82.6,regime:'SHORT SQUEEZE',clockAtLock:864,hour:3,session:'EU',windowType:'15m',signals:{gap:0.0,momentum:0.0,structure:0.0,flow:0.0,technical:0.0,regime:0.0},result:'WIN'},
  {id:1777446921794,dir:'UP',posterior:82.6,regime:'SHORT SQUEEZE',clockAtLock:878,hour:3,session:'EU',windowType:'15m',signals:{gap:0.0,momentum:0.0,structure:0.0,flow:0.0,technical:0.0,regime:0.0},result:'LOSS'},
  {id:1777452340531,dir:'UP',posterior:82.6,regime:'SHORT SQUEEZE',clockAtLock:860,hour:4,session:'EU',windowType:'15m',signals:{gap:0.0,momentum:0.0,structure:0.0,flow:0.0,technical:0.0,regime:0.0},result:'LOSS'},
  {id:1777480226162,dir:'UP',posterior:82.6,regime:'SHORT SQUEEZE',clockAtLock:874,hour:12,session:'US',windowType:'15m',signals:{gap:0.0,momentum:0.0,structure:0.0,flow:0.0,technical:0.0,regime:0.0},result:'WIN'},
  {id:1777492281874,dir:'UP',posterior:89.7,regime:'SHORT SQUEEZE',clockAtLock:519,hour:15,session:'US',windowType:'15m',signals:{gap:0.0,momentum:0.0,structure:0.0,flow:0.0,technical:0.0,regime:0.0},result:'WIN'},
  {id:1777492859609,dir:'UP',posterior:82.6,regime:'SHORT SQUEEZE',clockAtLock:841,hour:16,session:'US',windowType:'15m',signals:{gap:0.0,momentum:0.0,structure:0.0,flow:0.0,technical:0.0,regime:0.0},result:'LOSS'}
];
...
// V133: Reset just the directional/learning state, keep trade history + scorecard
...
const updateWeights=(weights,tradeLog,result)=>{
  // V133: Attribution-weighted gradient descent — only update signals that
  ...
  // V133: Use trade direction (UP/DOWN), not raw posterior sign — handles edge cases
  ...
  Object.keys(sig).forEach(k=>{
    ...
    // V133: ATTRIBUTION GATE — only update signals that contributed >10% of decision
...
const updateRegimeWeights=(regimeWeightsObj,trade,result)=>{
  ...
  // V133: use trade direction for alignment
  ...
  Object.keys(sig).forEach(k=>{
    if(!(k in newW))return;
    const contribution=Math.abs(sig[k])/totalAbs;
    // V133: attribution gate
    if(contribution<0.10)return;
    const aligned=Math.sign(sig[k])===tradeDirSign&&sig[k]!==0;
    let delta=(LEARNING_RATE*1.2)*contribution*conviction;
...
// V133: Chart Pattern Recognition
...
// V133: Brier Score — proper calibration metric for binary predictions
...
// V133: REAL BACKTEST FRAMEWORK — replay all historical trades and evaluate
...
const runFullBacktest=(tradeLog,opts={})=>{
  ...
  // V133: Apply our late-FOMO rule retroactively
...
// V133: Lightweight Backtest Audit
...
const runBacktest=(tradeLog,minSamples=10)=>{
  if(!tradeLog||tradeLog.length<minSamples)return{ready:false,n:tradeLog?.length||0};
...
// V133: Adaptive Threshold per Session × Regime
...
// V133: Regime-Direction WR Memory — explicit warning when locking into known weak combos
...
// V133: HPotter Future Grand Trend — multi-timeframe forecast
...
// V133: Aggregate finer-grained candles into a coarser timeframe
...
// V133: Volume Profile — find where most trading happened recently
...
// V133: useDepthFlash — high-frequency order book polling at 2.5s
...
// V133: Fetch candles at 1m, 3m, 5m, 15m for HPotter FGT analysis
...
const computeV99Posterior=(params)=>{
  ...
  // V133: VOLUME PROFILE / VPOC — support/resistance levels
  ...
  let trajectoryAdj=0;
  let trajectoryDirHint='NEUTRAL'; // V133: directional read for contradiction detection
  if(targetMargin>0&&_secsLeft>60&&Math.abs(_projectedGapBps)>8){
    // Projection points to where price will be at window end
    // Positive = above strike (favorable for UP), negative = below (favorable for DOWN)
    if(_projectedGapBps>0){
      trajectoryAdj=Math.min(12,_projectedGapBps*0.4);
      trajectoryDirHint='UP';
    } else {
      trajectoryAdj=Math.max(-12,_projectedGapBps*0.4);
  ...
  // V133: HPotter Future Grand Trend on 1m/3m/5m/15m
  ...
  // V133: FORECAST-STICKY removed — replaced by HPotter FGT (more rigorous)
  ...
  const gapClamped=Math.max(-W.gap,Math.min(W.gap,gapScore))*strikeQuality; // V133: scale by strike quality
  ...
  // V133: Momentum reweighting late in window
  ...
  // V133: LIVE ORDER BOOK FLASH — 2.5s polling vs bloomberg's 8s
  ...
  let liqAdj=0;
  // V133: Require wall persistence ≥15s (filters spoofed walls)
  ...
  // V133: Apply forward-looking trajectory adjustment
  ...
  // V133: Hardcoded DOWN penalty REMOVED — was creating structural UP bias
  ...
  // V133: BACKTEST-DRIVEN CALIBRATION (display-only, lock guards still use raw)
    ...
    <div className="flex flex-col flex-1 gap-3">
      <div className="flex flex-col items-center text-center pt-1">
        ...
        <div className="flex items-center gap-2 mb-1 flex-wrap justify-center">
          ...
          {/* V133: Regime-Direction WR warning */}
          ...
          {/* V133: Trajectory direction hint */}
          ...
          {/* V133: HPotter FGT multi-timeframe badge */}
        ...
        {/* V133: Plain-English summary line — always visible */}
        ...
        {/* V133: STAND DOWN banner — overrides chart reads */}
...
function NewsFeedCard(){
  ...
  // V133: also fetch macro event countdown — always shown even if news fails
  ...
  React.useEffect(()=>{
    ...
    const fetchNews=async()=>{
      // V133: Try multiple sources with timeout and fallback
    ...
    fetchNews();
    const iv=setInterval(fetchNews,30000); // V133: 30s polling
  ...
  return(
    <div className="shrink-0">
      ...
      {/* V133: Macro events countdown - always shown */}
...
const useNewsSentiment=()=>{
  const[sentiment,setSentiment]=React.useState({score:0,bullish:0,bearish:0,extreme:0,topHeadline:null,hasBreaking:false});
  React.useEffect(()=>{
    const fetchNews=async()=>{
      try{
        ...
        // V133: Check for "breaking" or "flash" tags — these are time-sensitive
        const hasBreaking=items.slice(0,5).some(n=>{
          const t=(n.title||'').toLowerCase();
          const ageMin=(Date.now()-(n.published_on*1000))/60000;
          return ageMin<=10&&(t.includes('breaking')||t.includes('flash')||t.includes('just in')||t.includes('urgent'));
        });
        ...
        setSentiment({score:bull-bear,bullish:bull,bearish:bear,extreme,topHeadline,hasBreaking}); // V133
      }catch(e){/* silent */}
    };
    fetchNews();
    // V133: Faster poll (30s vs 90s) — catch breaking news 60s sooner
...
// V133: Plain-English summary builder — converts structured analysis into a sentence
const buildPlainEnglish=(analysis,qualityGate,advisor)=>{
  ...
  if(dir.includes('LOCKED')){
    ...
    pieces.push('No clear edge yet');
  } else if(dir.includes('DELIBERATING')){
    const m=dir.match(/\[(\d+)s left\]/);
    const secs=m?parseInt(m[1]):0;
    return `🧠 Analyzing market — decision in ~${secs}s (sooner if signals align clearly)`;
...
// V133: Session Start Status Check — shows on first load
function SessionStartCheck({open,onClose,windowType,premiumMode,scorecards,tradeLog,regime,velocityRegime,calibration,baselineDrift,resetToLatestBaseline,runSyncWithProgress,syncState,resetDirectionalBias}){
  if(!open)return null;
  ...
  // V133 fix: calibration[k] is either a WR number or null (not a {wins,total} object)
  ...
  return(
    <div className="fixed inset-0 bg-black/70 z-50 flex items-center justify-center p-4" onClick={onClose}>
      <div className="bg-[#181A19] rounded-xl border border-[#E8E9E4]/10 p-5 max-w-md w-full max-h-[90vh] overflow-y-auto" onClick={e=>e.stopPropagation()}>
        ...
        {/* V133: Reset directional bias — keeps record, clears UP/DOWN learning lean */}
        ...
        <div className="space-y-3 text-xs">
          <div className="p-3 rounded-lg bg-[#111312] border border-[#E8E9E4]/8">
            ...
            <div className="text-white font-bold">{windowType.toUpperCase()} window · {premiumMode?'★ PREMIUM ON':'Premium OFF'}</div>
          </div>
          <div className="p-3 rounded-lg bg-[#111312] border border-[#E8E9E4]/8">
...
// V133: Compute weight changes for learning feedback
...
function TaraApp(){
  ...
  const[showSessionStart,setShowSessionStart]=useState(true); // V133: Session-start status check on load
  const[syncState,setSyncState]=useState({active:false,stage:'',progress:0,complete:false,error:null}); // V133: sync progress overlay
  ...
  const streakData=useMemo(()=>{
    ...
    // V133: Per-direction bias correction
  ...
  const regimeDirWR=useMemo(()=>buildRegimeDirWR(tradeLog),[tradeLog]); // V133
  const sessionRegimeThresh=useMemo(()=>buildSessionRegimeThresh(tradeLog),[tradeLog]); // V133
  ...
  const[chatLog,setChatLog]=useState([{role:'tara',text:'Tara V133 online — Canvas Chart + Weighted Signal Engine + Smart Advisor active.'}]);
  ...
  const depthFlash=useDepthFlash(); // V133: 2.5s order book polling
  const tfCandles=useMultiTFCandles(); // V133: HPotter FGT multi-timeframe data
  ...
  useEffect(()=>{setIsMounted(true);
    ...
    // V133: Baseline version check — detect if a newer baseline has shipped
    try{
    ...
    try{
      // V133: Try both legacy keys + handle baseline migration
      ...
      const cleanDU=(du&&!new RegExp('V1[0-9][0-9]').test(du||''))?du:'Tara V133'; // no regex literal — esbuild safe
  ...
  const broadcastToDiscord=async(type,data)=>{
    ...
    try{
      ...
      if(type==='SIGNAL')embed={
        ...
        footer:{text:'Tara V133  |  stand-down'},
        timestamp:new Date().toISOString(),
      };
      ...
      // Whale pressure alert — clinical, accurate, no hype
        ...
        embed={
          ...
          footer:{text:'Tara V133  |  futures tape  |  not financial advice'},
          timestamp:new Date().toISOString(),
        };
      }

      const res=await fetch(discordWebhook+'?wait=true',{method:'POST',headers:{'Content-Type':'application/json'},body:JSON.stringify({username:discordUsername||'Tara V133',avatar_url:discordAvatar||undefined,embeds:[embed]})});
      if(res.ok){
  ...
  const editDiscordMessage=async(entry,noteText)=>{
    ...
    try{
      ...
      const updatedEmbed={
        ...
        footer:{text:`Tara V133 · edited ${new Date().toLocaleTimeString('en-US',{hour:'2-digit',minute:'2-digit',hour12:true})}`},
      };
  ...
  const analysis=useMemo(()=>{
    try{
      ...
      // V133: Adaptive threshold per session×regime — tighter where Tara historically struggles
      ...
      // V133: Reduced base samples — Tara was waiting too long for confirmations
      // 15m: 3→2 samples (saves ~10s per call), 5m: 2→2 (no change, minimum)
      const _baseConsec=(is15m?2:2)+_regimeConsecAdj+_sessConsecAdj;
      // V133: Strong trajectory? Lock faster. Reduces sample requirement when direction is clear.
      const _trajStrength=Math.abs(eng.trajectoryAdj||0);
      const _trajShortcut=_trajStrength>=12?-2:_trajStrength>=8?-1:0;
      // V133: EXTREME velocity = lock at 1 sample regardless
      const _isExtreme=eng.velocityRegime==='EXTREME';
      // V133: PUSH-EARLIER — backtest shows sweet spot is 300-700s (73%+ WR) vs >820s (56.6% WR)
      ...
      const CONSECUTIVE_NEEDED=_isExtreme?1:Math.max(1,Math.round(_baseConsec*_velSampleAdj)+_trajShortcut+_push);
      ...
      // V133: SYMMETRIC DOWN THRESHOLD — mirror UP's 72 baseline, not 6pts harder
      // UP fires at posterior >= 72 (22pts above 50). DOWN should fire at posterior <= 28 (22pts below 50).
      // Gated regimes already get +1 confirmation sample requirement — don't double-penalize via threshold too.
      const LOCK_THRESHOLD_DN_EFFECTIVE=_downGated?(is15m?28:26):_downTDOnly?(is15m?32:30):(is15m?28:30)-_sessThreshAdj-_srThreshAdj; // V133: rebalanced from 22 → 28
      ...
      // V133: Gated regimes get +1 unless trajectory is strong (then no penalty)
      // V133: Match UP's sample requirement — was +1 in gated regimes, dropped that
      ...
      // V133: UP gate skipped when trajectory strong (don't slow good moves)
      ...
      if(!lockedCallRef.current){
        ...
        // V133: Whipsaw guard — track recent direction commitment, refuse small-move flips
        if(!windowSignalDirRef.current){
          ...
          // V133: Whipsaw guard with post-release relaxation
        ...
        // V133: DELIBERATION GATE — block locks during initial analysis phase
        ...
        // V133: early-clear ALSO requires MTF agreement — no fast lock against trend
        ...
        // V133 DECONFLICT: EXTREME velocity / rug pull bypasses deliberation entirely
        const _bypassDelib=eng.velocityRegime==='EXTREME'||(eng.isRugPull&&posterior<=45);
        ...
        // V133: Late lock allowed if trajectory is very strong (legitimate late breakouts)
          ...
          // V133 extra logging: announce when MTF would've blocked
          ...
          const _streakAdj=streakData?.warning?(streakData.strongWarn?-15:-8):(streakData?.type==='hot'&&streakData?.streak>=4?+4:0); const _dirBiasUp=streakData?.upBias||0; if(_dirBiasUp!==0)reasoning.push(`[DIR-BIAS] UP recent WR adj: ${_dirBiasUp}`); // V133
          // V133: SURGICAL LATE-FOMO PENALTY — only when signals contradict
          ...
          const _qScore=Math.min(40,Math.max(0,(Math.abs(posterior-50)-15)*1.6))+Math.min(30,(_rWR-50)*0.6)+Math.min(15,(_sessQ-50)*0.6)+(isLateLockZone?-8:0)+(isVeryLateLock?-20:0)+_dsAdj+_streakAdj+_lateFomoPenalty+_dirBiasUp+(eng.windowDriftBps>25?-Math.min(12,eng.windowExhaustionPenalty||0):0)+(eng.realGapBps<-25?-Math.min(20,Math.abs(eng.realGapBps)*0.4):0)+(newsSentiment?(newsSentiment.score>2?+5:newsSentiment.score<-2?(-8):0):0)+(()=>{
            // V133: Sentiment-Trajectory interaction
            ...
            if(tAdj<-5&&sScore>2)return-5;
            return 0;
          })(); // V114-V133: news sentiment + trajectory interaction for UP
          // V133: Signal consensus boost — when 5+ signals strongly agree, this IS A+
          ...
          const _quality=Math.max(0,Math.min(100,_qScore+5+_consensusBoost));
          ...
          if(_macroUP.state==='BLACKOUT'){
            ...
            // V133: Block UP lock when trajectory strongly favors DOWN (>8 magnitude opposing)
            ...
            // V133: In choppy regimes (RC/SS/HVC), demand quality >=62 to lock UP
            ...
            // V133 PREMIUM: 65+ quality OR strong trajectory bias
            ...
            // V133: in RC, allow lock if trajectory is strong (>8 bias)
          ...
          if(!dirAllowed){
            ...
            // V113+V133: Momentum confirmation with velocity-adaptive tolerance
            ...
            if(!momentumOK){
              ...
              lockedCallRef.current={dir:'UP',lockedAt:Date.now(),lockedPosterior:posterior,lockedRegime:regime,lockPrice:currentPrice,isLateLock:isLateLockZone,lockedSignals:eng.rawSignalScores?{...eng.rawSignalScores}:null}; // V133: snapshot signals at lock
        ...
        } else if((bearCount>=CONSECUTIVE_NEEDED_DN||(isRugPull&&posterior<=45))&&posterior<=LOCK_THRESHOLD_DN_EFFECTIVE&&!isEndgameLock&&!(eng.mtfAlignment!==undefined&&eng.mtfAlignment>=3)&&!(((regime==='HIGH VOL CHOP'||regime==='SHORT SQUEEZE'))&&!isRugPull&&Math.abs(eng.realGapBps||0)<25)){
          // V133: BACKTEST FINDING — DOWN locks in HVC/SS are coin flips (50% WR over 40 trades)
          ...
          // V133: Surgical DOWN late-FOMO — V133: TRENDING DOWN bypasses entirely (87% WR setup)
          ...
          const _qScore2=Math.min(40,Math.max(0,(Math.abs(posterior-50)-15)*1.6))+Math.min(30,(_rWR2-50)*0.6)+Math.min(15,(_sessQ2-50)*0.6)+(isLateLockZone?-8:0)+(isVeryLateLock?-20:0)+_dsAdj2+_streakAdj2+_lateFomoPenalty2+_dirBiasDn+(eng.windowDriftBps<-25?-Math.min(12,eng.windowExhaustionPenalty||0):0)+(eng.realGapBps>25?-Math.min(20,Math.abs(eng.realGapBps)*0.4):0)+(newsSentiment?(newsSentiment.score<-2?+5:newsSentiment.score>2?(-8):0):0)+(()=>{
            ...
            if(tAdj>5&&sScore<-2)return-5;
            return 0;
          })(); // V114-V133: news sentiment + trajectory interaction for DOWN (inverted)
          ...
          const _quality2=Math.max(0,Math.min(100,_qScore2+5+_consensusBoost2));
          ...
          if(_macroDN.state==='BLACKOUT'){
            ...
            // V133: Block DOWN when trajectory strongly favors UP
            ...
            // V133: choppy regimes demand quality >=62 to lock DOWN
            taraAdviceRef.current='WEAK SETUP — '+regime+' needs stronger signal';
          ...
          if(!dirAllowed){
            ...
            // V113+V133: Trajectory-aware momentum confirmation
            const recent=(velocityRef?.current?.v5s||0);
            const _momTol=velocityScalars?.momentumTol||0.5;
            ...
            if(!momentumOK){
              ...
              if(isRugPull&&bearCount<CONSECUTIVE_NEEDED_DN)reasoning.push(`[RUG-FIRE] Rug pull detected — DOWN locked early at posterior ${posterior.toFixed(0)}`); // V133: snapshot signals at lock
          ...
          // V133: SMART DELIBERATION — 15s baseline, extends if Tara needs more data
          ...
          // V133: SIT-OUT requires multiple confirmations of "no edge"
          ...
          const _midPosterior=avgRecent>=44&&avgRecent<=56; // V133: tightened from 42-58 to 44-56
          const _pastDeliberation=timeFraction>0.35;
          // V133: FGT must also be ambiguous (≤2 timeframes aligned)
          const _fgtAmbiguous=Math.abs(eng.mtfAlignment||0)<=2;
          // V133: Gap must be small (price near strike, no clear directional pressure)
          ...
          // V133: Sticky sit-out releases on ANY clear signal
          ...
          const _fgtClear=Math.abs(eng.mtfAlignment||0)>=3;
      ...
      if(lockedCallRef.current){
        ...
        // V133: SIGNAL REGIME CHANGE DETECTION
        ...
        let flippedSignals=[];
        if(lock.lockedSignals&&eng.rawSignalScores&&clockSeconds>(is15m?180:60)){
        ...
        if(deepWrong||catastrophicRugpull||decayCollapse||signalRegimeChange){
          lockedCallRef.current=null;posteriorHistoryRef.current=[];biasCountRef.current={UP:0,DOWN:0};
          // V133: reset window-direction commitment so flip to opposite direction is allowed
      ...
      else if(activePrediction.includes('DELIBERATING'))textColor='text-indigo-400';
      ...
      else if(activePrediction.startsWith('PREMIUM:'))textColor='text-amber-300'; // V112: Premium filtering active
  ...
  // V133: Audio alerts for trajectory milestones, breaking news, MTF confluence
  ...
  // ── V133: FLOW INTELLIGENCE — STRICTLY EVENT-TRIGGERED ──────────────
  ...
  const lastActivityAtRef=useRef(0); // V133: track when last meaningful activity happened
  useEffect(()=>{
    const fs=flowSignal;
    const now=Date.now();
    ...
    if(triggered){
      ...
      // V133: 30 second view window unless new activity — extends timer if more triggers
  ...
  // V133: Animated sync flow — shows progress overlay with staged updates
  ...
  const broadcastSignalManual=()=>{
    ...
    const isSearching=analysis.prediction?.includes('SEARCHING');
    const isStandDown=['BLACKOUT','OBSERVE','LOW QUALITY','SITTING OUT','PREMIUM:','BREAKING NEWS'].some(s=>analysis.prediction?.includes(s));
    // V133: Allow broadcasting any state with directional info OR stand-down state
    ...
    // V133: include plain-English summary
  ...
  if(!isMounted)return<div className={'min-h-screen bg-[#111312] flex items-center justify-center text-[#E8E9E4]/50 font-serif text-xl animate-pulse'}>Initializing Tara V133...</div>;
  ...
  return(
    <div className={'min-h-screen bg-[#111312] text-[#E8E9E4] font-sans flex flex-col selection:bg-[#E8E9E4]/20'} style={{fontSize:"16px",lineHeight:"1.5",overflowX:"hidden",maxWidth:"100vw"}}>
      ...
      {/* V133: Session-start status check */}
      ...
      {/* V133: SYNC PROGRESS OVERLAY ── shows during baseline sync */}
      {syncState.active&&(
      ...
      {/* V133: Learning toast removed — was crashing on minified prod build, will revisit */}
      {/* ── STICKY HEADER ── */}
        ...
        <div className="max-w-[1600px] mx-auto flex items-center gap-1 sm:gap-2">
          ...
          <div className="flex items-center gap-1 shrink-0">
            ...
            <span className={'hidden sm:flex items-center gap-1 text-[10px] font-sans bg-emerald-500/10 text-emerald-400 px-1.5 py-0.5 rounded-full border border-emerald-500/20'}>
              <span className="w-1.5 h-1.5 rounded-full bg-emerald-400 animate-pulse"></span> V133
            </span>
          </div>
          ...
          <div className="flex items-center gap-1 shrink-0">
            ...
            {/* V112: Premium Mode toggle — only fires A+ setups */}
            <button onClick={()=>setPremiumMode(!premiumMode)} className={'px-2 py-1 rounded-lg border text-[10px] font-bold uppercase tracking-wider transition-all '+(premiumMode?'bg-amber-500/20 border-amber-500/50 text-amber-300':'border-[#E8E9E4]/10 text-[#E8E9E4]/40 hover:text-amber-400')} title={premiumMode?'Premium Mode ON — only A+ quality setups (≥75) · MTF aligned · skips US session · skips weak RC':'Premium Mode OFF — all valid locks fire'}>
            ...
            <div className="p-4 sm:p-6">
              ...
              <div className={'mb-3 p-3 rounded-lg bg-[#111312] border border-[#E8E9E4]/10'}>
                <div className={'text-[11px] text-[#E8E9E4]/70 mb-2 leading-relaxed'}>
                  <strong className={'text-emerald-400'}>Sync to Latest Training</strong> · Refreshes Tara to the latest baked baseline (423W-266L · 31W-25L 5m · 377 baked trades · V133). Use when switching devices.
                </div>
                <button onClick={()=>{
      ...
      <div className={`fixed bottom-4 right-4 z-50 flex flex-col items-end transition-all ${isChatOpen?'w-[90vw] sm:w-80':'w-auto'}`}>
        {isChatOpen&&(
          <div className={'bg-[#181A19] border border-[#E8E9E4]/20 shadow-2xl rounded-xl w-full mb-3 overflow-hidden flex flex-col h-[55vh] sm:h-96'}>
            <div className={'bg-[#111312] p-2.5 flex justify-between items-center border-b border-[#E8E9E4]/10'}><span className="text-xs font-bold uppercase tracking-wide flex items-center gap-2"><IC.Msg className="w-3.5 h-3.5 text-indigo-400"/>Chat with Tara V133</span><button onClick={()=>setIsChatOpen(false)} className="opacity-50 hover:opacity-100"><IC.X className="w-4 h-4"/></button></div>
        ...
        <div className={'fixed inset-0 z-[100] bg-black/85 backdrop-blur-sm flex items-center justify-center p-2 sm:p-4'}>
          <div className={'bg-[#181A19] border border-[#E8E9E4]/20 rounded-2xl w-full max-w-3xl max-h-[95vh] mx-2 sm:mx-0 overflow-y-auto shadow-2xl'} style={{scrollbarWidth:'thin'}}>
            ...
            <div className="p-4 space-y-5">
              ...
              {/* V133: BACKTEST PANEL — replay all historical trades through current logic */}
              <section>
          ...
          <div className={'bg-[#181A19] border border-[#E8E9E4]/20 rounded-2xl w-full max-w-2xl max-h-[95vh] mx-2 sm:mx-0 overflow-y-auto shadow-2xl'} style={{scrollbarWidth:'thin'}}>
            <div className={'sticky top-0 bg-[#181A19] border-b border-[#E8E9E4]/10 p-4 flex justify-between items-center z-10'}>
              <div>
                <h2 className="text-base sm:text-lg font-serif text-white flex items-center gap-2">
                  <span className="text-indigo-400 text-xl font-bold">?</span> How Tara V133 Works
                </h2>
            ...
            <div className={'p-4 sm:p-6 space-y-6 text-sm text-[#E8E9E4]/80'}>
              ...
              <section className={'bg-emerald-500/5 border border-emerald-500/20 rounded-lg p-4'}>
                <h3 className={'text-emerald-400 font-bold uppercase tracking-wide mb-3 text-xs'}>🏆 Best Way to Use Tara (V133)</h3>
